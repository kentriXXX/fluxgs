...
-- Load checkpoints. client.error_log cannot be swallowed by a console filter, but it is
-- red and plays the error sound, so switch this off once everything works.
